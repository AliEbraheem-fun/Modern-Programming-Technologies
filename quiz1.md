...
(function() {
  var answers = {
    ...
    'Вопрос 50': 'Составные операторы присваивания: x += 3 эквивалентно x = (тип)(x + 3) — с неявным приведением типа. Для int разницы нет, но для byte/short/char приведение существенно. Аналогично работают -=, *=, /=, %=.',
