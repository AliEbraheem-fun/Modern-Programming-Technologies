...
<div class="quiz-question" data-correct="1">
<h4>Вопрос 22. Почему record неявно является допустимым наследником sealed-класса?</h4>
...
<div class="quiz-option" data-index="3">Локальный класс может содержать статические поля</div>
<div class="quiz-feedback"></div>
</div>
...
(function() {
  var answers = {
    ...
    'Вопрос 22': 'Record неявно является final, поэтому удовлетворяет требованию sealed-класса к наследникам.',
    ...
    'Вопрос 80': 'Локальный класс имеет имя, его можно использовать повторно в пределах метода. Анонимный — одноразовый.',
